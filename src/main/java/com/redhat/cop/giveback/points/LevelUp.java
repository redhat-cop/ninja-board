package com.redhat.cop.giveback.points;
...
public class LevelUp{
	...
	// Goes through all users scorecards and promotes/demotes depending on the thresholds in the config
...
//          new ChatNotification().send(ChatEvent.onBeltDemotion, displayName +" demoted to "+lastLevel.getRight());
          ChatNotification_v2.get().send(ChatEvent.onBeltDemotion, displayName +" demoted to "+lastLevel.getRight());
          count+=1;
        }
