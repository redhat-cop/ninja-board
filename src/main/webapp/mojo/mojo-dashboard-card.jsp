							...
							<td colspan="2">
								<table class="card2" border=0>
									...
									<tr>
										...
										<script>
											function switcharoo(id, caller){
												...
												if (!ele.hasClass("hidden")){
													...
													var uri="http://localhostx:8082/community-ninja-board/api/users/"+username;
													var values={};
										...
										<td class="cardName" colspan="2"><span class="_displayName"></span><input class="_displayName_edit hidden edit_box" type="textbox"/><i style="font-size:10pt;" class="fas fa-edit" onclick="switcharoo('displayName', this);"></i></td>
									...
									<tr>
										...
										<td><span class="_trelloId"></span><input class="_trelloId_edit hidden edit_box_small" type="textbox"/><i style="font-size:10pt;" class="fas fa-edit" onclick="switcharoo('trelloId', this);"></i></td>
									</tr>
									<tr>
										<td class="cardRow"><img  style="height:20px;" src="https://github.githubassets.com/images/modules/logos_page/GitHub-Logo.png"></td>
										<td><span class="_githubId"></span><input class="_githubId_edit hidden edit_box_small" type="textbox"/><i style="font-size:10pt;" class="fas fa-edit" onclick="switcharoo('githubId', this);"></i></td>
									</tr>
									<tr>
										<td class="cardRow">
										...
										<td><span class="_gitlabId"></span><input class="_gitlabId_edit hidden edit_box_small" type="textbox"/><i style="font-size:10pt;" class="fas fa-edit" onclick="switcharoo('gitlabId', this);"></i></td>
									</tr>
